...
6. **Native Search Protocol**: When you need to understand the dependencies or blast radius of a class or function, you MUST NOT use grep or view_file directly. Instead, you MUST use your native MCP tool `nodeos_spatial_search`. This will query the physical QuadTree graph and instantly return the exact code dependencies and spatial proximity cluster.
"""
